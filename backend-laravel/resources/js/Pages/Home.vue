                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div v-for="hp in recommendations" :key="hp.ranking" class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between">
                        <div>
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <h4 class="text-xl font-bold text-gray-900">{{ hp.Nama_HP }}</h4>
                                </div>
                                <span class="bg-indigo-100 text-indigo-700 text-xs font-bold px-2.5 py-1 rounded-full">Rank #{{ hp.Peringkat }}</span>
                            </div>
                            <div class="space-y-2 text-sm text-gray-600">
                                <div class="flex justify-between"><span>Harga:</span><span class="font-semibold text-gray-900">Rp {{ hp.C1 ? hp.C1.toLocaleString('id-ID') : 0 }}</span></div>
                                <div class="flex justify-between"><span>RAM:</span><span class="font-semibold text-gray-900">{{ hp.C2 }} GB</span></div>
                                <div class="flex justify-between"><span>Storage:</span><span class="font-semibold text-gray-900">{{ hp.C3 }} GB</span></div>
                            </div>
                        </div>
                        <div class="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center text-xs">
                            ...
                            <span class="font-bold text-indigo-600">{{ hp.Nilai_Optimasi_Yi ? hp.Nilai_Optimasi_Yi.toFixed(4) : '0.0000' }}</span>
                        </div>
                    </div>
                </div>
            </div>
